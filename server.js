...
// Core Pulse: 3 taps on the main JASLIN core activates MAX speed.
// Tap 1-2 = no speed change. Tap 3 = +10% for 5 seconds.
// The tap chain resets if the next tap is not made within 5 seconds.
const PULSE_STAGE_DURATION_MS = [0, 5000, 5000, 5000];
const PULSE_MULTIPLIERS = [1, 1, 1, 1.10];
