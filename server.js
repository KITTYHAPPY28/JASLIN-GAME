    ...
    try {
      ...
      if (reserveError) {
        ...
        if (msg.includes("jaslin_reserve_auto_withdrawal")) {
          return res.status(503).json({ error: "SQL Auto Withdrawal V5.1 belum dipasang di Supabase." });
        }
        throw reserveError;
      }
      ...
      await patchWithdrawal({
        ...
        error_message: chain.seqnoAdvanced ? null : "Submitted; confirmation polling pending"
      });
